...
# EIA
d_r = {'Family':1.0, 'Francis':1.0, 'Horse':1.0, 'Lighthouse':1.0,
       'M60':1.0, 'Panther':1.0, 'Playground':1.0, 'Train':1.0}
r_r = d_r

# nips_v1
s_all = {'Family':3, 'Francis':5, 'Horse':4, 'Lighthouse':2, 'M60':2, 'Panther':1, 'Playground':4, 'Train':3}
conf_all = {'Family':0.15, 'Francis':0.05, 'Horse':0.05, 'Lighthouse':0.01, 'M60':0.15, 'Panther':0.1, 'Playground':0.05, 'Train':0.1}
dist_all = {'Family':1/4*d_r['Family'], 'Francis':1/1*d_r['Francis'], 'Horse':1/4*d_r['Horse'], 'Lighthouse':1/4*d_r['Lighthouse'],
            'M60':1/4*d_r['M60'], 'Panther':1/1*d_r['Panther'], 'Playground':1/4*d_r['Playground'], 'Train':1/1*d_r['Train']}
rel_diff_all = {'Family':1/5000*r_r['Family'], 'Francis':1/4000*r_r['Francis'], 'Horse':1/2500*r_r['Horse'], 'Lighthouse':1/5000*r_r['Lighthouse'],
                'M60':1/3200*r_r['M60'], 'Panther':1/3000*r_r['Panther'], 'Playground':1/4500*r_r['Playground'], 'Train':1/3200*r_r['Train']}
...
def save_scene_depth(testlist):
    ...
    if args.dataset == 'tanks' or args.dataset == 'tanks_crop':

...
parser.add_argument("--n_views", type=int, default=11, help='number of input views')
...
parser.add_argument('--share_mamba', default=False, help='mamba share weights')
parser.add_argument('--share_attention', default=True, help='attention share weights')
parser.add_argument('--feat_mamba', default=False, help='mamba for multi-view feature enhancement')
...
if __name__ == '__main__':
    ...
    if args.dataset.startswith('dtu'):
        ...
        train_dataset = MVSDataset(args.trainpath, args.trainlist, "train", args.n_views, robust_train=args.rt, use_raw_train=args.use_raw_train)
